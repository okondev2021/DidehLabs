        ...
        >
          {steps.map((step) => (
            <motion.div
              ...
              className="border border-border bg-card p-8 flex flex-col justify-between min-h-[260px] hover:border-primary/45 transition-colors"
            >
              <div>
                <div className="flex justify-between items-center mb-6">
                  <span className="font-heading text-lg font-black text-primary tracking-wide">{step.num}</span>
