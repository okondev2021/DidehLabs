      ...
      <div className="relative z-10 mx-auto max-w-[1600px] px-4">
        ...
        <div className="relative flex flex-col items-center justify-center min-h-[650px] w-full max-w-5xl mx-auto px-2 md:px-4 overflow-visible">
          ...
          <div className="flex items-center gap-4 mt-8 relative z-10">
            <button
              onClick={handlePrev}
              className="p-3 border border-border bg-background hover:border-primary transition-colors text-foreground cursor-pointer rounded-sm flex items-center justify-center shadow-sm"
